...
- 2026-09-08: Mobile.html (學員報到介面) 的統計提示移除「參與率 X%」, 只留「已報到 N 人, 未報到 M 人」(`updateStats`, 連帶清掉 `rate` 變數與 `__prevStatsMobile.rate`). Desktop.html 管理端的參與率 (第 1321/1491 行兩處) **未動** — 她只點名學員端. 備份 `Mobile.html.bak-20260908-160148`.
